...
REG_I_NTC2_TEMPERATURE = 4082     # NTC2 — second outdoor/exhaust sensor
REG_I_RHT_HUMIDITY = 4083         # RHT — standalone humidity sensor
REG_I_FILTER_STATUS = 4100
REG_I_OPERATING_TIME = 4113       # 32-bit unsigned (high word 4113, low word 4114) — lifetime hours
...
REG_H_IMBALANCE_SUPPLY = 6035    # supply imbalance offset, signed %, -15..+15
REG_H_IMBALANCE_EXHAUST = 6036   # exhaust imbalance offset, signed %, -15..+15
